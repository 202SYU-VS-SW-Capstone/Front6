...
import com.ohgiraffers.recipeapp.service.IngredientImageService;
...
public class IngredientImageController {
    ...
    private final IngredientImageService service;

    public IngredientImageController(IngredientImageService service) {
    ...
    public ResponseEntity<IngredientImage> uploadImage(@RequestParam("file") MultipartFile file) {
