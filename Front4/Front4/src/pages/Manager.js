  ...
  return (
    <div className="manager-container">
      ...
      <div className="button-grid">
        ...
        <button onClick={() => handleNavigation('/recipe')} className="manager-button">레시피 등록</button>
        <button onClick={() => handleNavigation('/recipe')} className="manager-button">식재료 관리</button>
